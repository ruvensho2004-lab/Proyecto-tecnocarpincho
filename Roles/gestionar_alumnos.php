    ...
    try {
        ...
        switch ($accion) {
            case 'crear':
                ...
                // Crear alumno
                $sqlAlumno = "INSERT INTO alumnos (nombre_alumno, edad, direccion, cedula, telefono, correo, fecha_nac, fecha_registro, estado, usuario_id)
                             VALUES (:nombre, :edad, :direccion, :cedula, :telefono, :correo, :fecha_nac, NOW(), 1, :usuario_id)";
